    ...
    private static readonly IReadOnlyDictionary<int, AchievementKnowledge> AchievementKnowledgeMap =
        new Dictionary<int, AchievementKnowledge>
        {
            ...
            [81078] = new AchievementKnowledge
            {
                ...
                Targets =
                [
                    new TargetKnowledge(2301, "Gall Gem", "Given automatically by Shen Monkey in Chapter 1 -> Bamboo Grove -> Marsh of White Mist."),
                    new TargetKnowledge(2302, "Tender Jade Lotus", "Random harvest from Lotus plants, easiest from Chapter 1 -> Black Wind Cave -> Cave Interior."),
                    new TargetKnowledge(2303, "Laurel Buds", "Container in Chapter 2 -> Sandgate Village -> Village Entrance, near the big village gate."),
                    new TargetKnowledge(2304, "Steel Ginseng", "Random harvest from Ginseng plants, for example at Chapter 2 -> Fright Cliff -> Squall Hideout."),
                    new TargetKnowledge(2305, "Iron Pellet", "Buy from Man-in-Stone after finishing his Chapter 2 questline."),
                    new TargetKnowledge(2306, "Tiger Relic", "Hidden in the cellar route opened after the Chapter 2 Tiger Vanguard and Stone Vanguard bosses."),
                    new TargetKnowledge(2307, "Copper Pill", "Container on the path beyond Tiger Vanguard in Chapter 2 -> Crouching Tiger Temple."),
                    new TargetKnowledge(2308, "Goat Skull", "Random harvest from Licorice plants in Chapter 2 secret area -> Kingdom of Sahali -> Sandgate Bound."),
                    new TargetKnowledge(2309, "Celestial Lotus Seeds", "Buy from Shen Monkey starting in Chapter 3."),
                    new TargetKnowledge(2310, "Thunderbolt Horn", "Buy from Shen Monkey starting in Chapter 3."),
                    new TargetKnowledge(2311, "Stranded Loong's Whisker", "Hidden container on the island in Chapter 3 -> Snowhill Path -> Mirrormere."),
                    new TargetKnowledge(2312, "Breath of Fire", "Dropped by Cyan Loong on Turtle Island after getting Loong Scales."),
                    new TargetKnowledge(2313, "Turtle Tear", "Defeat Apramana Bat, inspect the skeleton, then collect the dropped green tear on the shore in Chapter 3."),
                    new TargetKnowledge(2314, "Sweet Ice", "Golden container at Chapter 3 -> New Thunderclap Temple -> Temple Entrance."),
                    new TargetKnowledge(2315, "Goji Shoots", "Golden container in Chapter 4 -> Webbed Hollow -> Upper Hollow."),
                    new TargetKnowledge(2316, "Purple-Veined Peach Pit", "One of the rewards from the five chests at Chapter 4 -> The Verdure Bridge route."),
                    new TargetKnowledge(2317, "Deathstinger", "Dropped by the scorpion enemy near the hidden village reached from The Verdure Bridge."),
                    new TargetKnowledge(2318, "Bee Mountain Stone", "Golden turtle container at Chapter 4 -> Temple of the Yellow Flower -> Mountain Trail."),
                    new TargetKnowledge(2319, "Fruit of Dao", "Random drop from the two monks just below Chapter 4 -> Court of Illumination shrine."),
                    new TargetKnowledge(2320, "Undying Vine", "Random drop from Verdant Glow enemies in Chapter 4 secret area -> Purple Cloud Mountain -> Valley of Blooms."),
                    new TargetKnowledge(2321, "Double-Combed Rooster Blood", "Dropped by Duskveil in the Chapter 4 secret area, Purple Cloud Mountain."),
                    new TargetKnowledge(2322, "Mount Lingtai Seedlings", "Golden turtle container on the main path from Chapter 5 -> Woods of Ember -> Camp of Seasons."),
                    new TargetKnowledge(2323, "Slumbering Beetle Husk", "Golden turtle container in Emerald Hall after beating Yin-Yang Fish."),
                    new TargetKnowledge(2324, "Flame Mediator", "Random drop from Searing-Fire enemies in Chapter 5 -> Field of Fire, including near Cooling Slope."),
                    new TargetKnowledge(2325, "Flower Primes", "Buy from Shen Monkey starting in Chapter 6."),
                    new TargetKnowledge(2326, "Graceful Orchid", "Reward from Chen Loong in Zodiac Village after turning in all 15 seed types."),
                    new TargetKnowledge(2327, "Guanyin's Willow Leaf", "Buy from Shen Monkey in New Game+."),
                ],
            },
